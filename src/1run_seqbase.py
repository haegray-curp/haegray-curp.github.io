...
def parse_args():
    ...
    parser.add_argument(
        # default="/home/vv2116/capstone_data/2017_1_subtask1.csv"
        "--seq_val_file", type=str,default="/home/vv2116/capstone_data/semeval2010t8_train_subtask1.csv", help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
        "--ratio",
    ...
    parser.add_argument(
        "--model_name_or_path",
        type=str,
        default='tanfiona/unicausal-pair-baseline',
...
def main():
    ...
    if args.do_predict:
        ...
        # op_file_vv = args.pair_val_file.split("/")[-1].split('.')[0].split('_')[0]
        op_file_vv = args.dataset_id
        with open(os.path.join(args.output_dir,f"subtask1_{op_file_vv}_predictions.txt"), "w") as writer:
