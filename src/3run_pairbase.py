...
def parse_args():
    ...
    parser.add_argument(
        "--pair_val_file", type=str, default='/home/vv2116/capstone_data/2017_1_subtask3.csv', help="A csv or a json file containing the validation data."
    )
    parser.add_argument(
        "--ratio",
...
def main():
    ...
    if args.do_predict:
        ...
        with open(os.path.join(args.output_dir,f"subtask3_{op_file_vv}_predictions.txt"), "w") as writer:
